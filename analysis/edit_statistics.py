    ...
    for event_type in total_events.keys():
        ...
        for edit_times in edited_events[event_type].values():
            if len(edit_times) > 1:
                ...
                duration = (last_edit - first_edit).total_seconds() / 60  # Convert to minutes
...
if __name__ == "__main__":
    ...
    overall_stats, per_event_stats = calculate_statistics(match_info.file_path)
    print_statistics(overall_stats, per_event_stats, match_info.match_name) 
